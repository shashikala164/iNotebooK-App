...
<form action="addAction.php" method="post" name="add" class="mt-4">
  <div class="form-row">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" name="impNote" class="form-control" id="inputPassword4" required>
    </div>
...
<table class="table table-bordered border-success mt-4 shadow-sm">
  <thead>
    <tr>
  ...
  <tbody>
    <!-- <tr>
      ...
      echo "<td>".$res['id']."</td>";
			...
			echo "<td><a type='button' class='btn btn-primary' href=\"edit1.php?id=$res[id]\">Edit</a> 
